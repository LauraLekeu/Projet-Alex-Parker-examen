...
/*
    ...
    ./app/vues/posts/addForm.php
      ...
      - $post = ARRAY(ARRAY title, text, created_at, quote, category_id)
      - $categories = ARRAY(ARRAY(categorieName, id, created_at))
              ...
              <div class="form-group">
                ...
                <select id="category" name="category_id" class="form-control">
                  <?php foreach ($categories as $categorie): ?>
                      <option value="<?php echo $categorie['id']; ?>" <?php if($categorie['id'] == $post['category_id']){echo 'selected="selected"';} ?>><?php echo $categorie['categorieName']; ?></option>
                  <?php endforeach; ?>
                </select>
              </div>
